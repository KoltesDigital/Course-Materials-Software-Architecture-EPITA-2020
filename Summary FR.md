...
On peut dont formuler la règle : les modules peuvent accéder aux modules inférieurs, mais ils n'ont pas le droit d'accéder aux modules supérieurs. Enfreindre cette règle entraîne des cycles de dépendance.
